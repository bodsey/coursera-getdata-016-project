...
run_analysis.R contains one function, run_analysis(), which will retrieve data files from a folder UCI HAR Dataset. This function will perform a sequence of commands, according to the Project instructions of Getting and Cleaning Data, a MOOC on Coursera.
...
3/ Processed Data
79 variables which are means for raw data means and std. Activity is a string describing the activity. Subject is an integer id.
See above for the details of the processing.
